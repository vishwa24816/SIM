    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground">
        <header className="sticky top-0 z-40 bg-primary/95 backdrop-blur-sm text-primary-foreground">
            ...
            <div className="px-4 overflow-x-auto">
                <div className="flex items-center gap-6 text-sm font-medium text-primary-foreground/70 whitespace-nowrap">
                    <Button variant="ghost" className="p-0 h-auto">Portfolio</Button>
                    <Button variant="ghost" className="p-0 h-auto">Fiat</Button>
                    <Button variant="ghost" className="p-0 h-auto">Wealth</Button>
                    <Button variant="ghost" className="p-0 h-auto text-primary-foreground font-semibold border-b-2 border-primary-foreground">Crypto</Button>
                    <Button variant="ghost" className="p-0 h-auto">Web3</Button>
                </div>
            </div>
        </header>
